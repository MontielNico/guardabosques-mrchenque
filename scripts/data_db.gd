		...
		2:
			...
			return [
				...
				},
				{
					...
					"declared_passengers": 1,
					"actual_passengers": 1,
					"visitor_type": "Pescador en Veda (Salida / Inspección Obligatoria)",
					"is_mandatory_event": true,
					"event_id": "rare_fisherman",
					"dialog_intro": "Buenas tardes, Mr. Chenque... vengo saliendo del acantilado. Tengo la captura cerrada, pero venía con un pescado que no se parece a ninguno de los de la costa. Esto se tiene que revisar antes de que me vaya.",
					"dialog_interrogate": "Tengo DNI, Pase y Permiso de Pesca Artesanal vigentes. El ejemplar no está en regla y lo traigo para que lo inspeccione antes de salir del parque.",
					"stated_activity": "Salida del Acantilado con Captura Inspeccionada",
					"doc": {
						"name": "Lautaro Pejerrey",
						...
						"date": "28/11/2026",
						"purpose": "Salida de Acantilado / Captura Inspeccionada",
					...
					"car_items": ["Caña de pescar pesada", "Caja cerrada con pescado anómalo", "Malla de pesca"],
					"should_pass": true,
					"rejection_reasons": [],
					"parcel_impact": {}
				}
