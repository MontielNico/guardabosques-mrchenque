...
@onready var doc_type_label: Label = get_node_or_null("DeskMargin/DeskVBox/DocCenterContainer/DocPreviewCard/DocInfoOverlay/DocTypeLabel")
@onready var doc_owner_label: Label = get_node_or_null("DeskMargin/DeskVBox/DocCenterContainer/DocPreviewCard/DocInfoOverlay/DocOwnerLabel")
